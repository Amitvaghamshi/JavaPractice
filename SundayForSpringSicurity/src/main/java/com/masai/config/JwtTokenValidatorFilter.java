...
public class JwtTokenValidatorFilter extends OncePerRequestFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		String jwt= request.getHeader(SecurityConstants.JWT_HEADER); // ==comes From Security Constent which is created by us
...
//				Authentication auth = new UsernamePasswordAuthenticationToken(username, null, authorities); 
	...
	protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException{
		...
		return request.getServletPath().equals("/signIn");  // ==> in parameter we have to pass for which controller it should not check 
	}
